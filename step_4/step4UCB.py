...
cumulative_regret1_, cumulative_reward1, final_reward1, clairvoyant_margin_values1 = iterate(learner, env, iteration, daily_interaction, clairvoyant_price_index, "step4UCB")
