...
class ContextGenerator:
    ...
    def collect_daily_data(self, pulled_arms, coll_rewards, visited_products, num_bought_products, num_primaries, features):
        """
        ...
        if self.collected_rewards is None:
            self.collected_rewards = coll_rewards
        else:
            self.collected_rewards = np.vstack((self.collected_rewards, coll_rewards))
    ...
    def iterate_over_features(self, leaf):
        ...
        for feature in available_features:
            ...
            left_learner = self.get_offline_trained_learner(pulled_arms=self.collected_arms[left_split_indices],
                                                            reward=self.collected_arms[left_split_indices],
    ...
    def get_offline_trained_learner(self, pulled_arms, reward, visits, num_bought, num_primaries):
        """
