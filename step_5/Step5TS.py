...
######### TS
learner = TSLearner(lamb, secondary, class_choosed, different_value_of_prices, step=5)
...
iterate(learner, env, iteration, daily_simulation, clairvoyant_price_index, "step5TS")
